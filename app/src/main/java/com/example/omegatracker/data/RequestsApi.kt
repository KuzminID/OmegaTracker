...
interface RequestsApi {
    ...
    @GET("/api/issues?fields=id,summary,description,project(name,shortName),customFields(value(minutes,name,isResolved),minutes,name,id),created")
    suspend fun getIssuesList(@Header("Authorization") authToken: String?): Response<List<IssueFromJson>>
}